...
public extension Generators {
    ...
    static func collect<G>(_ generators: [G]) -> AnyGenerator<[G.T]> where G: Generator {
    ...
    ///
    /// - Returns: The generator of Arrays containing values selected in order from the provided generators
    static func collect<G, R>(_ generators: [G], _ transform: @escaping (G.T) -> R) -> AnyGenerator<[R]> where G: Generator {
