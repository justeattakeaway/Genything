...
public extension Generatable {
    ...
    func zip<A>(_ other: A) -> Generatables.Zip<Self, A> where A: Generatable {
    ...
    ///
    /// - Returns: A generator of Tuples
    func zip<A, R>(_ other: A, transform: @escaping (Self.T, A.T) -> R) -> Generatables.Map<(Self.T, A.T), R>
    where A: Generatable {
    ...
    ) -> Generatables.Map<(A.T, B.T), R> where A: Generatable, B: Generatable {
...
public extension Generatable {
    ...
    ///
    /// - Returns: A generator of Tuples
    func zip<B, C, R>(_ b: B, _ c: C, transform: @escaping (T, B.T, C.T) -> R) -> Generatables.Map<(Self.T, B.T, C.T), R>
    ...
    ) -> Generatables.Map<(A.T, B.T, C.T), R> where A: Generatable, B: Generatable, C: Generatable {
...
public extension Generatable {
    ...
    ///
    /// - Returns: A generator of Tuples
    func zip<B, C, D>(_ b: B, _ c: C, _ d: D) -> Generatables.Zip4<Self, B, C, D>
    ...
    ///
    /// - Returns: A generator of Tuples
    func zip<B, C, D, R>(_ b: B, _ c: C, _ d: D, transform: @escaping (T, B.T, C.T, D.T) -> R) -> Generatables.Map<(Self.T, B.T, C.T, D.T), R>
    where B: Generatable, C: Generatable, D: Generatable {
    ...
    ) -> Generatables.Map<(A.T, B.T, C.T, D.T), R>
    where A: Generatable, B: Generatable, C: Generatable, D: Generatable {
...
public extension Generatable {
    ...
    ///
    /// - Returns: A generator of Tuples
    func zip<B, C, D, E, R>(_ b: B, _ c: C, _ d: D, _ e: E, transform: @escaping (Self.T, B.T, C.T, D.T, E.T) -> R) -> Generatables.Map<(Self.T, B.T, C.T, D.T, E.T), R>
    where B: Generatable, C: Generatable, D: Generatable, E: Generatable {
    ...
    ) -> Generatables.Map<(A.T, B.T, C.T, D.T, E.T), R>
    where A: Generatable, B: Generatable, C: Generatable, D: Generatable, E: Generatable {
...
extension Generatables {
    public struct Zip<A, B>: Generatable where A: Generatable, B: Generatable {
          ...
          E: Generatable
    {
        ...
        public func start() -> Gen<(A.T, B.T, C.T, D.T, E.T)> {
